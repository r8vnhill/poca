...
class CardSpec : WordSpec({
    ...
    "Two cards with the same parameters" should {
        "Be equal" {
            val charizard2 = Card(CHARIZARD_NAME, CHARIZARD_TYPE, CHARIZARD_HP)
        ...
        "Have the same hash code" {
            val charizard2 = Card(CHARIZARD_NAME, CHARIZARD_TYPE, CHARIZARD_HP)
            charizard should haveSameHashCodeAs(charizard2)
            val mew2 = Card(MEW_NAME, MEW_TYPE, MEW_HP)
    ...
    "Two Pokémon with different parameters" should {
        "Not be equal" {
            val charizard2 = Card(CHARIZARD_NAME, CHARIZARD_TYPE, 100)
        ...
        "Not have the same hash code" {
            val charizard2 = Card(CHARIZARD_NAME, CHARIZARD_TYPE, 100)
            charizard shouldNot haveSameHashCodeAs(charizard2)
            val mew2 = Card(MEW_NAME, MEW_TYPE, 100)
